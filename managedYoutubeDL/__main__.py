...
def manualDownload(**kwargs):
  ...
  if quality_str not in Manager.VideoQuality:
    raise SystemError(f"Unknown video quality {quality_str}. Supported qualitities: {[x.value for x in Manager.VideoQuality]}")
